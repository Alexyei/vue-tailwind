...
<!--            <p>Все</p>-->
<!--          </div>-->
          <div @click.prevent="repeat" :class="{'pointer-events-none':loadingWords}"
               class="cursor-pointer py-2 md:mx-0 md:py-0 md:my-2 md:px-2 flex justify-center items-center flex-col">
...
<!--                            </g>-->
<!--                        </svg>-->
            <svg v-else class="text-blue-500 hover:text-dark-gray w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
