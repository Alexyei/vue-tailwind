<template>
  <div class="bg-whitesmoke w-full min-h-full h-full flex flex-col">
    <nav-bar>
      <span class="text-text-dark text-xl md:text-2xl leading-none py-4 block font-TT">{{words[9].translate}}</span>
    </nav-bar>
...
<!--        </div>-->
<hint-panel :is-active="isActive" :word="words[9].word"></hint-panel>
        <div
            ref="writeAreaParent"
